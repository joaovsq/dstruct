...
unittest {
    ...
    static assert(getPropertyEmbeddedClassName!(EMUser, "userName") == "dstructtests.EMName");
    ...
    static assert(getPropertyReferencedClassName!(Person, "moreInfo") == "dstructtests.MoreInfo");
    ...
    //  }
    schema = new SchemaInfoImpl!(dstructtests); //Person, MoreInfo, EvenMoreInfo, 
